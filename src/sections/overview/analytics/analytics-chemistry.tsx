      ...
      >
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <ToggleButtonGroup
            ...
            color="primary"
          >
            <ToggleButton value={2} sx={{ fontWeight: 700 }}>
              2개
            </ToggleButton>
            <ToggleButton value={3} sx={{ fontWeight: 700 }}>
              3개
            </ToggleButton>
            <ToggleButton value={4} sx={{ fontWeight: 700 }}>
              4개
            </ToggleButton>
            <ToggleButton value={5} sx={{ fontWeight: 700 }}>
              5개
            </ToggleButton>
          </ToggleButtonGroup>
        </Stack>
